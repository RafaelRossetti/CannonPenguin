...
export class Environment {
    ...
    draw(cameraX) {
        ...
        for (let x = - (cameraX % 100); x < width; x += 100) {
            ...
            this.ctx.lineTo(x + 50, this.groundY + 10);
            this.ctx.stroke();
        }
        ...
        this.boosters.forEach(b => {
            ...
            if (b.type === 'cloud') {
                ...
                this.ctx.beginPath();
                this.ctx.arc(sx, b.y, b.radius, 0, Math.PI * 2);
                this.ctx.arc(sx + 20, b.y - 10, b.radius * 0.8, 0, Math.PI * 2);
                this.ctx.arc(sx - 20, b.y - 10, b.radius * 0.8, 0, Math.PI * 2);
                this.ctx.fill();
                
                this.ctx.fillStyle = 'rgba(255,255,255,0.8)';
                this.ctx.font = '20px sans-serif';
                this.ctx.fillText('⚡', sx - 10, b.y + 5);
            } else {
                this.ctx.fillStyle = b.color;
                this.ctx.fillRect(sx - 30, b.y - 10, 60, 10);
                this.ctx.fillStyle = '#white';
                this.ctx.fillRect(sx - 20, b.y - 15, 40, 5);
            }
        });
    }
}
